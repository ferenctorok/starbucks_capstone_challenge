...
def get_training_data(profile, transcript, portfolio, target_dir='data', target_file='training_data.csv',
                      ...
                      pruning_cache_file_to_write='pruned_received_offers.csv'):
    ...
    if pruning_cache is not None:
        received_offers = pruning_late_offers(received_offers, portfolio,
                                              ...
                                              cache_file_to_write=pruning_cache_file_to_write)
    else:
        received_offers = pruning_late_offers(received_offers, portfolio,
                                               cache_file_to_write=pruning_cache_file_to_write)
    ...
    for i, offer in received_offers.iterrows():
        ...
        viewed_offers_person = viewed_offers[viewed_offers.person == person]
        viewed_offers_this = viewed_offers_person[viewed_offers_person.offer_id == offer_id]
        completed_offers = transcript[completed_mask & time_mask]
        completed_offers_person = completed_offers[completed_offers.person == person]
        completed_offers_this = completed_offers_person[completed_offers_person.offer_id == offer_id]
...
def pruning_late_offers(received_offers, portfolio, cache_file=None, cache_file_to_write='pruned_received_offers.csv'):
    ...
    if cache_data is None:
        ...
        # saving cache:
        cache_dir = 'cache'
        cache_file = cache_file_to_write
